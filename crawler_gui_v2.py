...
def gen_post_links(target_fb,N_TARGET):
    def get_link(i):
        l = [f'/html/body/div[1]/div[1]/div[1]/div/div[3]/div/div/div/div[1]/div[1]/div/div/div[4]/div[2]/div/div[2]/div[3]/div[{i}]/div/div/div/div/div/div/div/div/div/div/div[2]/div/div/div[2]/div/div[2]/div/div[2]/span/span/span[2]/span/a',
             f'/html/body/div[1]/div[1]/div[1]/div/div[3]/div/div/div/div[2]/div[1]/div/div/div[4]/div[2]/div/div[2]/div[3]/div[{i}]/div/div/div/div/div/div/div/div/div/div/div[2]/div/div/div[2]/div/div[2]/div/div[2]/span/span/span[2]/span/a',
...
def get_detail(link):
    def get_fdetail(link):
        ...
        n_comment = find_text(n_comments)
        # print('n_comment',n_comment)
        ...
        n_share = find_text(n_shares)
        # print('n_share',n_share)
        ...
        texts = find_text(texts)
        # print('texts',texts)

        comments = []
        for i in range(1,51):
            cs = [f'/html/body/div[1]/div[1]/div[1]/div/div[3]/div/div/div/div[1]/div[1]/div/div/div/div/div/div/div/div/div/div/div/div/div/div[2]/div/div/div[4]/div/div/div[2]/ul/li[{i}]/div[1]/div[2]/div[2]/div[1]/div[1]/div/div/span[1]/a/span/span',
                  f'/html/body/div[1]/div[1]/div[1]/div/div[3]/div/div/div/div[1]/div[1]/div/div/div/div/div/div/div/div/div/div/div/div/div/div[2]/div/div/div[4]/div/div/div[2]/ul/li[{i}]/div[1]/div/div[2]/div/div[1]/div/div[1]/div/div/span/a/span/span',
                  f'/html/body/div[1]/div[1]/div[1]/div/div[3]/div/div/div/div[1]/div[1]/div/div/div/div/div/div/div/div/div/div/div/div/div/div[2]/div/div/div[4]/div/div/div[2]/ul/li[{i}]/div[1]/div[2]/div[1]/div[1]/div/div/span/a/span/span',
                  f'/html/body/div[1]/div[1]/div[1]/div/div[3]/div/div/div/div[1]/div[1]/div/div/div/div/div/div/div/div/div/div/div/div/div/div[2]/div/div/div[4]/div/div/div[2]/ul/li[{i}]/div[1]/div[2]/div/div[1]/div/div[1]/div/div/span/a/span/span']
            c = find_text(cs)
            if c:
                comments.append(c)
    ...
    def get_emosions(N_target):
        def read_person(N_target):
            ...
            while p and i <= N_target:
                f = [f'/html/body/div[1]/div[1]/div[1]/div/div[4]/div/div/div[1]/div/div[2]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[1]/div[{i}]/div/div/div[2]/div[1]/div/div/div/span/div/a']
                e = [f'/html/body/div[1]/div[1]/div[1]/div/div[4]/div/div/div[1]/div/div[2]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[1]/div[{i}]/div/div/div[1]/div/a/div/div[2]/div/div[1]/img']
                p = find_text(f)

                if p:
                    icon_link = find_src(e)
    ...
    # print('n_like',n_like,type(n_like))
    if isinstance(n_like, int):
        ...
        N_target_emosion = 10
    # print('N_target_emosion',N_target_emosion)
    # print(date,n_like,n_comment,n_share,texts,comments,location)
    time.sleep(3)
